...
const Resent_updatesComponent = () => {
  return (
    ...
    <div className='three_boxes_wrapper'> 
       <div className='big_box'>
            ...
            <div className='right_side_up'>
              ...
              <NavLink to={"/readmore"}><div className='butt_in_style'>
          ...
          <div className='small_left_box_wraeppr'>
            ...
            <div className='comp_inside_right'>
              ...
              <div className='comp_center_side'>
                  ...
                  <NavLink to={"/readmore"}><button className='small_read'>Read More</button></NavLink>
                </div>
    ...
    <div className='Resent_uptadats_Center'>
    ...
    <div className='three_boxes_wrapper_m'> 
       <div className='big_box'>
            <div className='left_side_up'>
              <img className='up_two_style' src={up_two} alt='image'/>
            </div>
    ...
    <div className='Resent_uptadats_smaller'>
      
    <div className='small_left_box_wraeppr_two'>
